...
switch (platform) {
    ...
    switch (arch) {
      case "arm64":
        localFileExisted = existsSync(
          join(__dirname, "tokenizers.android-arm64.node")
        );
        try {
          if (localFileExisted) {
            nativeBinding = require("./tokenizers.android-arm64.node");
          } else {
            nativeBinding = require("@inference-net/tokenizers-android-arm64");
          }
        } catch (e) {
          loadError = e;
        }
      ...
      case "arm":
        localFileExisted = existsSync(
          join(__dirname, "tokenizers.android-arm-eabi.node")
        );
        try {
          if (localFileExisted) {
            nativeBinding = require("./tokenizers.android-arm-eabi.node");
          } else {
            nativeBinding = require("@inference-net/tokenizers-android-arm-eabi");
          }
        } catch (e) {
          loadError = e;
        }
      ...
      case "x64":
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require("@inference-net/tokenizers-win32-x64-msvc");
          }
        } catch (e) {
          loadError = e;
        }
      ...
      case "ia32":
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require("@inference-net/tokenizers-win32-ia32-msvc");
          }
        } catch (e) {
          loadError = e;
        }
      ...
      case "arm64":
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require("@inference-net/tokenizers-win32-arm64-msvc");
          }
        } catch (e) {
          loadError = e;
        }
  ...
  case "darwin":
    localFileExisted = existsSync(
      join(__dirname, "tokenizers.darwin-universal.node")
    );
    try {
      if (localFileExisted) {
        nativeBinding = require("./tokenizers.darwin-universal.node");
      } else {
        nativeBinding = require("@inference-net/tokenizers-darwin-universal");
      }
      break;
    } catch {}
    switch (arch) {
      case "x64":
        localFileExisted = existsSync(
          join(__dirname, "tokenizers.darwin-x64.node")
        );
        try {
          if (localFileExisted) {
            nativeBinding = require("./tokenizers.darwin-x64.node");
          } else {
            nativeBinding = require("@inference-net/tokenizers-darwin-x64");
          }
        } catch (e) {
          loadError = e;
        }
      ...
      case "arm64":
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require("@inference-net/tokenizers-darwin-arm64");
          }
        } catch (e) {
          loadError = e;
        }
  ...
  case "freebsd":
    ...
    localFileExisted = existsSync(
      join(__dirname, "tokenizers.freebsd-x64.node")
    );
    try {
      if (localFileExisted) {
        nativeBinding = require("./tokenizers.freebsd-x64.node");
      } else {
        nativeBinding = require("@inference-net/tokenizers-freebsd-x64");
      }
    } catch (e) {
      loadError = e;
    }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require("@inference-net/tokenizers-linux-x64-musl");
            }
          } catch (e) {
            loadError = e;
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require("@inference-net/tokenizers-linux-x64-gnu");
            }
          } catch (e) {
            loadError = e;
          }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require("@inference-net/tokenizers-linux-arm64-musl");
            }
          } catch (e) {
            loadError = e;
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require("@inference-net/tokenizers-linux-arm64-gnu");
            }
          } catch (e) {
            loadError = e;
          }
      ...
      case "arm":
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require("@inference-net/tokenizers-linux-arm-gnueabihf");
          }
        } catch (e) {
          loadError = e;
        }
